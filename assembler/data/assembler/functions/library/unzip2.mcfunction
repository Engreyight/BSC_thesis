...
# output: score lower memory, storage assembler:memory memory, storage assembler:memory pieces, score higher memory, storage assembler:memory memory0, storage assembler:memory pieces0, score parity memory
# uses: score mod memory, score rank memory, score childrank memory, score index1 memory, storage assembler:memory copy, score found memory
