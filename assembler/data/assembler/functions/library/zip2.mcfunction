...
# uses: score rank memory, score piecerank memory, storage assembler:memory copy, score newchildcount memory
...
execute if score rank memory > piecerank memory store result score newchildcount memory run data get storage assembler:memory memory.childcount
execute if score rank memory > piecerank memory run scoreboard players add newchildcount memory 1
execute if score rank memory > piecerank memory store result storage assembler:memory memory.childcount int 1 run scoreboard players get newchildcount memory